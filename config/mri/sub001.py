...
def get_args():
    args_edict = edict()
    args_edict.dataset_dir = '/ssd1tb_00/byeonginjoung/dataset'
    args_edict.name_scene = 'sub001'
    #args_edict.scene_sizes = [[-2.7, 2.8], [-2.4, 2.3], [-1.2, 2.0]]
    #args_edict.scene_sizes = [[-1.5, 1.8], [-1.5, 1.3], [-1.5, 1.2]]
    #args_edict.voxel_sizes = [0.011, 0.08, 0.24, 0.48]
    args_edict.scene_sizes = [[-0.8, 0.8], [-0.8, 0.8], [-0.2, 0.2]]
    args_edict.voxel_sizes = [0.01, 0.01, 0.01]
    ...
    #args_edict.asdf_loss.growing_trunc_last_val = 0.05
    args_edict.asdf_loss.growing_trunc_last_val = 0.02
