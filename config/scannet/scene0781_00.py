...
def get_args():
    ...
    args_edict.name_scene = 'scene0781_00'
    #args_edict.scene_sizes = [[-7.0, 4.0], [-3.2, 3.3], [-1.5, 1.5]]
    args_edict.scene_sizes = [[-6.6, 4.3], [-2.5, 3.4], [-1.8, 1.6]]
    args_edict.voxel_sizes = [0.02, 0.08, 0.24, 0.48]
